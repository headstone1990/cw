...
public class Presets : MonoBehaviour
{
    ...
    void Display()
    {
        if (selectedPreset == "White")
        {
            ...
            description.text =
                "Кот с такими чертами характера может стать жестоким, но справедливым предводителем.\nОднако отношения со Звёздным племенем и целителем будет сложно назвать хорошими.";
        ...
        else if (selectedPreset == "Brown")
        {
            ...
            description.text =
                "Кот с таким характером способен стать верным другом предводителю и помощником для всего племени.\nХоть воин он прекрасный, хорошим собеседником его не назвать.";
            trait0.text = "Добрый";
            trait1.text = "Угрюмый";
        ...
        else if (selectedPreset == "Black")
        {
            ...
            description.text =
                "Неизвестно, Звёздное племя отвернулось от этого кота, или же он сам отверг Звёздное племя.\nАвантюрист и одиночка с щедрой душой способен стать отличным бродягой.";
            trait0.text = "Скептик";
            trait1.text = "Грубый";
